      ...
      ${styles.bgWhite} ${banner}`}>
        ...
        {showBtn && (
          <Button
            ...
            link="https://expo.dev/@juanrodrigo123/nftProject?serviceType=classic&distribution=expo-go"
          />
        )}
          ...
          >
        <img src={mockupImg} alt="mockup" className={`${styles.flexCenter} ${!reverse ? "fadeRightMini" : "fadeLeftMini"}`} />
